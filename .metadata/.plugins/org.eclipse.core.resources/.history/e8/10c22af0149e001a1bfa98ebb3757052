...
public class StartScreen {
	...
	/**
	 * Tells the game the window can be closed
	 */
	...
	private void initialize() {
		...
		friendlyFarmButton.setToolTipText("Start with $10,000, Animals stay happier and healthier for longer");
		...
		fertileFarmButton.setToolTipText("Start with $10,000, Higher yield for crops");
		...
		fastFarmButton.setToolTipText("Start with $10,000, Crops grow faster");
		...
		richFarmButton.setToolTipText("Start with $15,000");
